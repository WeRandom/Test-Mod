package com._shadow_.tbmem.client.screen;
...
public class DisplayCaseScreen extends ContainerScreen<DisplayCaseContainer> {
    ...
    private static final ResourceLocation DISPLAY_CASE_GUI = new ResourceLocation(TestMod.MOD_ID, "textures/gui/display_case.png");
    ...
    protected void drawGuiContainerForegroundLayer(MatrixStack matrixStack, int x, int y) {
        this.font.func_243248_b(matrixStack, this.playerInventory.getDisplayName(), (float) this.playerInventoryTitleX, this.playerInventoryTitleY, 4210752);
    }
